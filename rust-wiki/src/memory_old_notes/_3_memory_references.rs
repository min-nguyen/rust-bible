...
// A reference's lifetime is the region of code that begins when it is declared and ends when it is last used.
//    A reference is guaranteed by Rust to always be valid i.e. point to valid data during its lifetime.
...
//    A reference's lifetime is the region of code that begins when it is declared, and ends when it is last used.
//    It is used to ensure that a reference is always valid i.e. it points to valid data.
